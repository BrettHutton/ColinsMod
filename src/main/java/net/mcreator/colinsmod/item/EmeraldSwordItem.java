...
import net.mcreator.colinsmod.procedures.EmeraldSwordAttackProcedure;
import net.mcreator.colinsmod.ColinsModElements;

@ColinsModElements.ModElement.Tag
public class EmeraldSwordItem extends ColinsModElements.ModElement {
	@ObjectHolder("colinsmod:emeraldsword")
	public static final Item block = null;
	public EmeraldSwordItem(ColinsModElements instance) {
		super(instance, 15);
	}
		...
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity entity2) {
				...
				World world = entity.world;
				{
					...
					EmeraldSwordAttackProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
