...
public class CupcakdBlock extends ColinsModElements.ModElement {
	@ObjectHolder("colinsmod:cupcakd")
	public static final Block block = null;
	public CupcakdBlock(ColinsModElements instance) {
		super(instance, 10);
	}
