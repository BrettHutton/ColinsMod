...
public class RainbowlavaBlock extends ColinsModElements.ModElement {
	@ObjectHolder("colinsmod:rainbowlava")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("colinsmod:rainbowlava_bucket")
	public static final Item bucket = null;
	private FlowingFluid flowing = null;
	private FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public RainbowlavaBlock(ColinsModElements instance) {
		super(instance, 11);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("colinsmod:blocks/rainbowlava"), new ResourceLocation("colinsmod:blocks/rainbowlava"))
						.luminosity(0).density(1000).viscosity(1000)).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("rainbowlava");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("rainbowlava_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.LAVA)) {
		}.setRegistryName("rainbowlava"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("rainbowlava_bucket"));
	}
