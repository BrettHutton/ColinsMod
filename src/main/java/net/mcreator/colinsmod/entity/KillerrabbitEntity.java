...
package net.mcreator.colinsmod.entity;
...
public class KillerrabbitEntity extends ColinsModElements.ModElement {
	public static EntityType entity = null;
	public KillerrabbitEntity(ColinsModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -65536, -16777216, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("killerrabbit"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 20, 1, 30));
		}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 5, Ingredient.fromItems(new ItemStack(Items.EMERALD, (int) (1)).getItem()), false));
			...
			this.goalSelector.addGoal(5, new RandomWalkingGoal(this, 9));
			this.goalSelector.addGoal(6, new RandomWalkingGoal(this, 50, 20) {
				@Override
			...
			this.goalSelector.addGoal(9, new LeapAtTargetGoal(this, (float) 9));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.DIAMOND, (int) (1)));
		}
